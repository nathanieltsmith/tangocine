...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Musician.lastName'
        db.alter_column(u'tango_disco_musician', 'lastName', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Musician.firstName'
        db.alter_column(u'tango_disco_musician', 'firstName', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'RecordLabel.name'
        db.alter_column(u'tango_disco_recordlabel', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'Musician.lastName'
        db.alter_column(u'tango_disco_musician', 'lastName', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'Musician.firstName'
        db.alter_column(u'tango_disco_musician', 'firstName', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'RecordLabel.name'
        db.alter_column(u'tango_disco_recordlabel', 'name', self.gf('django.db.models.fields.CharField')(max_length=30))
