...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recording.singer'
        db.add_column(u'tango_disco_recording', 'singer',
                      self.gf('django.db.models.fields.CharField')(default='Instrumental', max_length=300),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recording.singer'
        db.delete_column(u'tango_disco_recording', 'singer')
    ...
    models = {
        ...
        u'tango_disco.recording': {
            ...
            'singer': ('django.db.models.fields.CharField', [], {'default': "'Instrumental'", 'max_length': '300'}),
