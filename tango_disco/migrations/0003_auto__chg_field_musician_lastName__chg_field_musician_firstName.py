...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'tango_disco_musician', 'lastName', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Musician.firstName'
        db.alter_column(u'tango_disco_musician', 'firstName', self.gf('django.db.models.fields.CharField')(max_length=200))
