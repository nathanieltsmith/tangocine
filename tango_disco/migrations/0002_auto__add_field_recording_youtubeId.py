...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recording.youtubeId'
        db.add_column(u'tango_disco_recording', 'youtubeId',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recording.youtubeId'
        db.delete_column(u'tango_disco_recording', 'youtubeId')
