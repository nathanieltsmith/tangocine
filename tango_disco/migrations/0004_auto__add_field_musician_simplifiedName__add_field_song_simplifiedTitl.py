...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Musician.simplifiedName'
        db.add_column(u'tango_disco_musician', 'simplifiedName',
                      self.gf('django.db.models.fields.CharField')(max_length=400, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Song.simplifiedTitle'
        db.add_column(u'tango_disco_song', 'simplifiedTitle',
                      self.gf('django.db.models.fields.CharField')(max_length=300, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Musician.simplifiedName'
        db.delete_column(u'tango_disco_musician', 'simplifiedName')

        # Deleting field 'Song.simplifiedTitle'
        db.delete_column(u'tango_disco_song', 'simplifiedTitle')
