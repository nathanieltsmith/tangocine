...
urlpatterns = patterns('',
    ...
    url(r'^filter/(?P<performer1>[+|%|2|0|a-zA-Z]+)/(?P<performer2>[+|%|2|0|a-zA-Z]+)/(?P<orchestra>[a-zA-Z]+)/(?P<song>[+|%|2|0|a-zA-Z]+)/(?P<genre>[a-zA-Z]+)/(?P<sort_method>[\-?|_|a-zA-Z]+)/', views.filter, name='filter'),
