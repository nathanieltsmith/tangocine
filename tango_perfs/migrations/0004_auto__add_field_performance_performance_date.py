...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Performance.performance_date'
        db.add_column(u'tango_perfs_performance', 'performance_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Performance.performance_date'
        db.delete_column(u'tango_perfs_performance', 'performance_date')
