...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Performance.event'
        db.alter_column(u'tango_perfs_performance', 'event_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tango_perfs.DanceEvent'], null=True))

    def backwards(self, orm):

        # Changing field 'Performance.event'
        db.alter_column(u'tango_perfs_performance', 'event_id', self.gf('django.db.models.fields.related.ForeignKey')(default='exit', to=orm['tango_perfs.DanceEvent']))
