...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Performance.thumbnailUrl'
        db.add_column(u'tango_perfs_performance', 'thumbnailUrl',
                      self.gf('django.db.models.fields.CharField')(default='http://terryshoemaker.files.wordpress.com/2013/03/placeholder1.jpg', max_length=100),
                      keep_default=False)

        # Adding field 'Performance.previousTotalViews'
        db.add_column(u'tango_perfs_performance', 'previousTotalViews',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Performance.hotness'
        db.add_column(u'tango_perfs_performance', 'hotness',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Performance.totalViews'
        db.add_column(u'tango_perfs_performance', 'totalViews',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Performance.youtubeUploadDate'
        db.add_column(u'tango_perfs_performance', 'youtubeUploadDate',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Performance.thumbnailUrl'
        db.delete_column(u'tango_perfs_performance', 'thumbnailUrl')

        # Deleting field 'Performance.previousTotalViews'
        db.delete_column(u'tango_perfs_performance', 'previousTotalViews')

        # Deleting field 'Performance.hotness'
        db.delete_column(u'tango_perfs_performance', 'hotness')

        # Deleting field 'Performance.totalViews'
        db.delete_column(u'tango_perfs_performance', 'totalViews')

        # Deleting field 'Performance.youtubeUploadDate'
        db.delete_column(u'tango_perfs_performance', 'youtubeUploadDate')
