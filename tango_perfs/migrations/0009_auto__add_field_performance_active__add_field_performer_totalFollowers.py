...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Performance.active'
        db.add_column(u'tango_perfs_performance', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Performer.totalFollowers'
        db.add_column(u'tango_perfs_performer', 'totalFollowers',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Performance.active'
        db.delete_column(u'tango_perfs_performance', 'active')

        # Deleting field 'Performer.totalFollowers'
        db.delete_column(u'tango_perfs_performer', 'totalFollowers')
